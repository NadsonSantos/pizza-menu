  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-4 flex items-center gap-4">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-red-600 font-bold text-sm mt-0.5">{formatCurrency(bebida.preco)}</p>
      </div>
      <button
        type="button"
        onClick={onAdd}
        className="bg-red-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-red-700 active:scale-95 transition-all cursor-pointer"
      >
        + Add
      </button>
    </div>
